...
def build_tools() -> List[Dict[str, Any]]:                 # ✏️ Build 1, step 1.3
    ...
    return [
        ...
        },
        {
            ...
            "description": (
                "Search what other flights Larkspur has for this booking's disrupted route. "
                "Only call this if the flight has been cancelled or the delay is over 2 hours "
                "long; use the status from get_flight_status to decide. "
                "Returns options, each with an option_id that hold_seat needs."
            ),
            "input_schema": {
                "type": "object",
